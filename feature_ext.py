...
def test(data,
    ...
    gdrive_path = '/content/gdrive/MyDrive/results/labels/'
    # save_dir = Path(gdrive_path, exist_ok=opt.exist_ok)
    ...
    abs_dir_pred_stor = Path(save_dir, 'predn')
